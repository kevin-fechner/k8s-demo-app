...
class OrderEventConsumerTest {
  ...
  void onOrderCreated_DelegatesToEmailService() {
    ...
    consumer.onOrderCreated(
        orderCreatedEvent, "OrderCreatedEvent".getBytes(StandardCharsets.UTF_8));
  ...
  void onOrderCreated_SkipsWrongEventType() {
    consumer.onOrderCreated(
        orderCreatedEvent, "OrderStatusChangedEvent".getBytes(StandardCharsets.UTF_8));
  ...
  void onOrderStatusChanged_DelegatesToEmailService() {
    ...
    consumer.onOrderStatusChanged(
        orderStatusChangedEvent, "OrderStatusChangedEvent".getBytes(StandardCharsets.UTF_8));
  ...
  void onOrderStatusChanged_SkipsWrongEventType() {
    consumer.onOrderStatusChanged(
        orderStatusChangedEvent, "OrderCreatedEvent".getBytes(StandardCharsets.UTF_8));
