...
public class InventoryEventConsumer {
  ...
  public void onStockUpdated(
    ...
    String eventType =
        eventTypeBytes != null ? new String(eventTypeBytes, StandardCharsets.UTF_8) : null;
    ...
    log.info(
        "Stock confirmed for orderId={}, product={}, remaining={}",
        event.orderId(),
        event.productId(),
  ...
  public void onStockInsufficient(
      @Payload StockInsufficientEvent event,
      @Header(value = "eventType", required = false) byte[] eventTypeBytes) {
    String eventType =
        eventTypeBytes != null ? new String(eventTypeBytes, StandardCharsets.UTF_8) : null;
    ...
    log.warn(
        "Stock insufficient for orderId={}, product={}, requested={}, available={}",
        event.orderId(),
        event.productId(),
