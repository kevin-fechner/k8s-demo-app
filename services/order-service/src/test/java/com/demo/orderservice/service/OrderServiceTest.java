...
class OrderServiceTest {
  ...
  void setUp() {
    ...
    testProduct = new ProductDto(1L, "Test Product", "Description", new BigDecimal("49.99"), 100);
  }
  ...
  void updateStatus_ExistingId_ReturnsUpdatedOrder() {
    ...
    OrderResponse result =
        orderService.updateStatus(1L, new UpdateStatusRequest(OrderStatus.CONFIRMED));
  ...
  void getOrders_NoResults_ReturnsEmptyPage() {
    ...
    CursorPage<OrderResponse> result =
        orderService.getOrders(null, 10, new OrderFilter(null, null, null, null));
  ...
  @Test
  @DisplayName(
      "Should set hasMore=true and encode the last ID as nextCursor when results exceed page size")
